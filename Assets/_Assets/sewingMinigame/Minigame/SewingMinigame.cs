...
namespace DonBosco
{
    public class SewingMinigame : MonoBehaviour
    {
        ...
        public void ChangeMapInput()
        {
            ...
            // Pastikan CharacterMovement aktif kembali
            CharacterMovement playerMovement = FindObjectOfType<CharacterMovement>();
            if (playerMovement != null)
            {
                playerMovement.enabled = true;
                Debug.Log("CharacterMovement Re-enabled manually");
            }
        }
    }
}
